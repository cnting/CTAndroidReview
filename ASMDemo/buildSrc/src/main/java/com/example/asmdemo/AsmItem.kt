...
class AsmItem(
    ...
    /**
     * AsmItem(oriClass=android/app/ActivityManager,
     * oriMethod=getRunningAppProcesses,
     * oriDesc=()Ljava/util/List;,
     * oriAccess=182,
     * targetClass='com/example/asmdemo/compile_hook/PrivacyUtil',
     * targetMethod='getRunningAppProcesses',
     * targetDesc='(Landroid/app/ActivityManager;)Ljava/util/List;', targetAccess=184)
     */
